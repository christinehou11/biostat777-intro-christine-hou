...
::: callout-note
You can choose to click the link and export the dataset using the 'Export' buttom on the web page. 
You can also choose to download *data.zip* from my GitHub directory. I compressed the dataset into *data.zip*, and stored it in GitHub directory for convenience. If the website accidently expires, you can get access to the dataset by visiting my <a href = "https://github.com/christinehou11/biostat777-intro-christine-hou/blob/main/data.zip">GitHub directory</a>.
:::
